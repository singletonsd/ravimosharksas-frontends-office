...
@Component({
  selector: 'app-contracts-table-options',
  templateUrl: './contracts-table-options.component.html',
  styleUrls: ['./contracts-table-options.component.scss']
})
export class ContractsTableOptionsComponent extends BaseTableOptions<any> implements OnInit {
